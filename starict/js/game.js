...
function Basketball() {
    ...
    timerself = 30,
    this.displayScore = 0,
    this.storage = "undefined" != typeof Storage ? !0 : !1;
    var t;
    var w, h;
    ...
    this.start = function () {
        ...
        this.hoops.push(new Hoop(120, 520), new Hoop(372, 520), new Hoop(246, 260));
        var timer = setInterval(function () {
            ...
            if (timerself <= 0) {
                this.state = "over";
                setTimeout(function () {
                    window.location.href = "end.html?score=" + scorenext;
                }, 3000);
                clearInterval(timer);
    ...
    this.drawLoadingScreen = function () {
        ...
        t.fillStyle = "black",
        t.fillRect(0, 0, 960, 640),
        t.textAlign = "center",
        this.drawText(t, "Loading...", 320, 480, 40),
        t.textAlign = "left"
    }, 
    this.getResources = function () {
        /*图片放置区*/
        var t = ["image/background.png", "image/ball.png", "image/hoop.png", "image/t1.png", "image/t2.png", "image/t3.png"],
            s = ["image/bounce_1.wav"];
    ...
    this.update = function (t) {
        if (timerself >= 1 && "menu" == this.state && (gameStart(),this.click && (this.state = "play", this.click = !1),this.menuText.update(t)),"play" == this.state) {
            gameStart(),
            this.ballX += this.ballVel * t, this.ballX > 547 && (this.ballVel = -this.ballVel, this.ballX = 547),
                        ...
                        if (52 > o && (i.scored || (i.setAngle(90), scorenext = this.score += 10, this.texts.push(new PopText("+ 10", h.x, h.y))), i.scored = !0), !i.scored)
                            for (var c = 0; c < h.points.length; c++) {
                                var d = h.points[c],
                                    ...
                                    l = d.y - i.y,
                                    o = Math.sqrt(r * r + l * l),
                                    g = Math.atan2(d.y - i.y, d.x - i.x);
                                if (o > 54 && !i.canBounce && (i.canBounce = !0), 52 > o && i.canBounce) {
                                    this.playSound("image/bounce_1.wav"),
                                    i.bounces++, i.setAngle(180 * g / Math.PI + 180 + Math.floor(10 * Math.random()) - Math.floor(10 * Math.random())), i.bounces > 3 && (i.bounces = 3);
                                    var v = 180 * g / Math.PI;
                                    v > 0 && 180 > v && (i.gravity = 950 + 100 * i.bounces), i.angleVel = -i.angleVel, i.canBounce = !1
                                }
                            }
                    }
                i.update(t), i.y > 960 && (this.ballX = i.x, this.balls.splice(s, 1), i.scored || (this.flashText.push(
                    new FlashText("差一点"))))
            }
            if (this.click && this.ballY <= 950 && this.balls.length < 1) {
                var i = new Ball(this.ballX + 46.5, this.ballY);
                i.drawAngle = this.ballAngle,
                i.shoot(1480), this.balls.push(i),
                this.ballY = 961
            }
        ...
        if ("over" == this.state) {
            ...
            this.overText.update(t),
            gameOver(this.score)
        }
        "over" == this.state && this.click && (this.score = 0, this.time = 60, this.balls = [], this.state = "menu", this.click = !1, this.scored = 0, this.missed = 0, this.flashText = []),
         this.ballAngle += 100 * t
    }, 
    this.draw = function (t) {
        if (t.drawImage(this.res["image/background.png"], 0, 0), "menu" == this.state && (this.menuText.draw(t), this.ctx.textAlign = "center", t.textAlign = "left"), "play" == this.state) {
            ...
            this.balls.length < 1 && drawImage(t, this.res["image/ball.png"],
            this.ballX,this.ballY, 0, 0, 93, 93, 45,45, this.ballAngle),
            t.textAlign = "left",
            this.drawText(t, this.score + "  分", w / 2, 70, 40);
...
function Hoop(t, s) {
    this.x = t, this.y = s, this.move = !1, this.vel = 100, this.points = [{
        x: t + 7,
        y: s + 18
    }, {
        x: t + 141,
...
function Ball(t, s) {
   ...
   this.shoot = function (t) {
    ...
    this.update = function (t) {
        ...
        this.y < 300 && (this.solid = !0),
        this.gravity > this.speed && (this.falling = !0), this.x + 47 > 640 && (this.vx = -1 * this.vx, this.x = 593),
        this.x - 47 < 0 && (this.vx = -1 * this.vx, this.x = 47),
...
function PopText(t, s, i) {
    ...
    this.draw = function (t) {
        ...
        game.drawText(t, this.string, this.x + 15, this.y),
        t.globalAlpha = 1
    }
}
...
function AnimatedText(t, s, i, e, h) {
    this.string = t,
        ...
        this.toNextSize = 0,
        this.update = function (t) {
            this.size += this.vel * t,
            this.size >= 60 ? (this.vel = -this.vel, this.size = 60) : this.size <= 40 && (this.vel = -
            this.vel, this.size = 40)
        },
        this.draw = function (t) {
            t.save(),
            t.textAlign = "center",
            game.drawText(t, this.string, this.x, this.y, this.size),
            t.restore()
        }
}
...
function FlashText(t) {
        ...
        this.draw = function (t) {
            ...
            t.save(),
            t.globalAlpha = this.opacity,
            game.drawText(t, this.string, 320, 480, this.size),
            t.restore()
        }
}
...
function drawImage(t, s, i, e, h, a, n, r, l, o, c) {
        ...
        t.drawImage(s, h, a, n, r, -l, -o, n, r),
        t.restore()
}

function gameStart() {
    isEnterOver && (isEnterOver = !1,
    overTimer = clearTimeout(overTimer))
}

function gameOver(t) {
    isEnterOver || (isEnterOver = !0,
    overTimer = clearTimeout(overTimer),
